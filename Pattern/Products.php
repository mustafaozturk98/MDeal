...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
                    ...
                    <div class="d-flex">
                       <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                                <span class="fas fa-shipping-fast  border p-3 rounded"></span>
                            </div>
                            <a href="#" class="font-rale font-size-12">same day shipping<br>Delivered</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                                <span class="fas fa-check border p-3 rounded"></span>
                            </div>
                            <a href="#" class="font-rale font-size-12">1 Year <br>guarantee</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                                <span class="fas fa-undo border p-3 rounded"></span>
                            </div>
                    ...
                    <div class="col-6">
                        <div class="color my-3">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="p-2 color-blue-bg rounded-square"><button class="btn font-size-14"></button></div>
                                <div class="p-2 color-primary-bg rounded-square"><button class="btn font-size-14"></button></div>
                                <div class="p-2 color-second-bg rounded-square"><button class="btn font-size-14"></button></div>
                            </div>
                        </div>
            ...
            <div class="col-12">
                <h6 class="font-georama">Product Description</h6>
                <hr>
